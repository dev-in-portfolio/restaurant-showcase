// The Orbit Experience — 3D Particle, Parallax & Live-Fire Engine

class OrbitMasterCanvasEngine {
  ...
  initScene() {
    this.particles = [];
    const count = Math.min(Math.floor(window.innerWidth / 9), 110);
...
window.OrbitMasterCanvasEngine = OrbitMasterCanvasEngine;
