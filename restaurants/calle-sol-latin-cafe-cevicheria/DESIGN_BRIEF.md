# Creative Design Brief: Calle Sol Latin Café & Cevicheria
...
- **Visual Tone**: Bespoke Artisanal Culinary & Dining Showcase aesthetics. Primary accent `#6366f1`, deep background `#0b1329`.
- **Typography**: Display font `'Playfair Display', serif` paired with `'DM Sans', sans-serif`.
- **Signature Feature**: Calle Sol Latin Café & Cevicheria Interactive Flavor Explorer.
...
- **Visual Tone**: Rejected as too generic for Calle Sol Latin Café & Cevicheria.

## 3. Art Direction Rationale
- **Color Logic**: Accent `#6366f1` for callouts with `#0b1329` background.
- **Typography Logic**: Hierarchy using `'Playfair Display', serif` for titles and `'DM Sans', sans-serif` for legibility.
