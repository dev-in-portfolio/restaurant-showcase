document.addEventListener('DOMContentLoaded', function () {
  ...
  // 3. Guest range slider (events.html)
  ...
  function updateRange() {
    ...
    if (c) {
      c.textContent = 'For ' + v + ' guests, collect date, preferences and requirements before a real handoff to Matthews Social House.';
    }
  }
  ...
  document.querySelectorAll('[data-demo]').forEach(function (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      if (toast) {
        toast.textContent = 'Demo complete — nothing was sent to Matthews Social House.';
