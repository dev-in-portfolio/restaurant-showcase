...
// This script fetches the restaurant's metadata and injects a floating
// button referencing the restaurant's current online presence.

document.addEventListener("DOMContentLoaded", () => {
  fetch("restaurant.json")
    .then(response => {
      if (!response.ok) {
        throw new Error("Metadata file (restaurant.json) not found");
      }
